...
\ee
The coefficient $\l_\mathbf{1}$ must be matched to the UV theory just like all the others. It is a ``local counterterm" that is not captured by the effective field theory and encodes the effects of UV degrees of freedom.
...
\item $\gamma$: The zero-field susceptibility involves an additional derivative
\be
...
\a + \b(1+\de) &= 2.
\ee
Historically, these scaling relations played an important role in verifying the above picture of the renormalization group.

\subsection{The Wilson-Fisher theory}
